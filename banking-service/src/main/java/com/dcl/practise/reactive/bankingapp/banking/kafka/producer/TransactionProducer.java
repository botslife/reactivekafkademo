package com.dcl.practise.reactive.bankingapp.banking.kafka.producer;
...
public class TransactionProducer {
    ...
    public void sendMessage(Transaction transaction){
        Message<Transaction> msg = MessageBuilder.withPayload(transaction)
                ...
                .build();
        log.info("Transaction processed to dispatch: {} ; Message dispatch successful: {} ",msg,streamBridge.send("transaction",msg));
    }
}
